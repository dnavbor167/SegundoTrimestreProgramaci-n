...
public class Vehiculo {
    ...
    public int hashCode() {
        ...
        hash = 67 * hash + Objects.hashCode(this.tarifa);
        return hash;
    }
    ...
    //Este método podrá acceder tanto el vehículo como los hijos
    //si el método fuese privado, los hijos no pueden acceder
    //para que un método privado lo pueda ver las clases hijas se pondrán protected
    //así: protected void algo()
    public void descontarTarifa(double cantidad) {
